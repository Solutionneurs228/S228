            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                       <div class="name">
                            <h1>MIX TECHNOLOGY CENTER</h1>
                            <h6>Un bon travail en un temps record !!!</h6>
                        </div>

                        <p> Maintenance - Informatique - Photographie - Agrandissement - Réportage vidéo </p>
                        <p> Infographie - Créations de sites web et d'application mobiles - Formations </p>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Photographie Reportage</h5>
                        <p>Photos - Agrandissement - Reportage & montage vidéo</p>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p>Création de sites Web et Applications mobiles sur mésure</p>
                    </div>
                </div>
            </div>
            <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
            ...
            <div class="session-content">
                    ...
                    <div class="box">
                        ...
                        <div class="webContent">
                            ...
                            <div class="contentImg">
                                <a href="#" target="_blank"><img src="images/2.JPG" class="contentImage"></a>
                            </div>
                ...
                {{-- <div class="cards">
                    ...
                    <div class="card" style="">
                        ...
                        <div class="card-body">
                            ...
                            <div class="btn-right">
                                ...
                                <a href="#" class="btn btn-primary card-btn">voir la page</a>
                            </div>
                    ...
                    <div class="card" style="">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Photographie & Vidéographie</h5>
                            <p class="card-text">Prise de vues, Photos shooting, Agrandissement de photos, Reportages photo
                                & vidéo ...</p>
                            <div class="btn-right">
                    ...
                    <div class="card" style="">
                        <img class="card-img-top" src="images/1.JPG" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">Infographie</h5>
                            <p class="card-text">Création de cartes de visites, d'invitations, logos, badges, affiches
                                pubs, bâches, autocollants ...</p>
                            <div class="btn-right">
                                <a href="#" class="btn btn-primary">voir la page</a>
                            </div>
                    ...
                    <div class="box">
                        ...
                        <div class="webContent">
                            ...
                            <div class="wrapperText">
                                {{-- <h2 class="card-title title"> --}}
                                    <div>
                                        <h5 class="card-title">Initiation à l'informatique</h5>
                    ...
                    <div class="box">
                        ...
                        <div class="webContent">
                            ...
                            <div class="wrapperText">
                                {{-- <h2 class="card-title title"> --}}
                                    <div>
                                        <h5 class="card-title">Informatique Avancée</h5>
                                        <p class="card-text">En fonction du niveau de l'apprenant la formation va couvrir les bases et
