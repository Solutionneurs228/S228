                ...
                <div class="elt">
                            ...
                            <div class="service-session-content-right">
                                ...
                                <div class="service-session-description">
                                    ...
                                    <p>
                                        ...
                                        ou
                                        logiciel.
                                        En termes d'entretien, nous assurons des mises à jour régulières, un nettoyage
                                        physique
                                        pour
                                        éviter la
                    ...
                    <section class="service-session" id="assistance1">
                        <div class="service-session-container">
                            ...
                            <div class="service-session-content-left">
                                <div class="sectionTitle">
                                    <span class="titleNumber">02 . </span>
                                    <h4 class="titleText">
                                ...
                                <div class="service-session-description">
                                    ...
                                    <p>
                                        nous somme bien indiqués pour voir quel(s) ordinateur(s) il vous faut (bureaux ou
                                        portatif),
                                        de
                                        quelles performences minimales, en fontion de votre travail quels sont les logiciels
                                        à y
                                        installer ...
                                    </p>
                                </div>
                            ...
                            <div class="service-session-img-right">
                                <img src="../images/mir.webp" alt="Réparation et entretien des ordinateurs">
                            </div>
                            ...
                            <div class="service-session-content-right">
                                ...
                                <div class="service-session-description">
                                    <ul>
                                        ...
                                        <li>ou votre est déjà informatisé mais il vous faut la meilleur façon de tirer
                                            profit de
                                            l'informatique ?</li>
                                    </ul>
                                    <p>
                        ...
                        <div class="service-session-container">
                            ...
                            <div class="service-session-content-right">
                                <div class="sectionTitle">
                                    <span class="titleNumber">04 . </span>
                                    <h4 class="titleText">
                                        initiation dans le travail en équipe, à distance avec un bon système de
                                        collaboration
                                        informatique
                                        <div class="underline">
                                            <span></span>
                                ...
                                <div class="service-session-description">
                                    <ul>
                                        <li>votre entreprise a un nombre d'ordinateurs dont le travail est complémentaire ?
                                        </li>
