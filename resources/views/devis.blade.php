...
@section('meta_description',
    'Obtenez un devis gratuit pour nos services IT, développement web, design graphique et production audiovisuelle. Contactez-nous dès aujourd\'hui pour une estimation personnalisée de votre projet au Togo.')
        ...
        <div class="container">
            ...
            <div class="forms-container">
                ...
                <div id="contact-form" class="form-wrapper active">
                    <div class="form-grid">
                        <div class="form-card">
                            <h3 class="form-title">Demandez un devis</h3>
