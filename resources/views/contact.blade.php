...
<section class="contact-section">
        <div class="container">
            ...
            <div class="form-toggle">
                <button class="toggle-btn active" onclick="switchForm('contact')">Message Rapide</button>
                <button class="toggle-btn" onclick="switchForm('devis')">Demande de Devis</button>
            </div>
                        ...
                        <div class="form-card">
                            ...
                            <form onsubmit="handleSubmit(event, 'contact')">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="contact-name" name="name" required placeholder="Votre nom et prénom">
                                </div>
                        ...
                        <div class="info-card">
                            ...
                            <div class="contact-info-item">
                                ...
                                <div class="contact-details">
                                    <h4>Téléphone</h4>
                                    <p><a href="tel:+228XXXXXXXX">+228 XX XX XX XX</a><br>
                                    <span style="font-size: 0.8rem; color: var(--text-muted);">Lun-Ven, 8h-18h</span></p>
                                </div>
                            </div>
                            ...
                            <div class="contact-info-item">
                                ...
                                <div class="contact-details">
                                    <h4>Email</h4>
                                    <p><a href="mailto:contact@solutionneurs228.tg">contact@solutionneurs228.tg</a><br>
                                    <span style="font-size: 0.8rem; color: var(--text-muted);">Réponse sous 24h</span></p>
                                </div>
                            </div>
                            ...
                            <div class="contact-info-item">
                                ...
                                <div class="contact-details">
                                    <h4>Adresse</h4>
                                    <p>Lomé, Togo<br>
                                    <span style="font-size: 0.8rem; color: var(--text-muted);">Quartier [Votre quartier]</span></p>
                                </div>
                            </div>
                ...
                <div id="devis-form" class="form-wrapper">
                    <div class="form-grid">
                        <div class="form-card">
                            ...
                            <p class="form-subtitle">Décrivez votre projet pour recevoir une estimation détaillée sous 48h.</p>

                            <div class="success-message" id="devis-success">
                                ✅ Votre demande de devis a été envoyée ! Notre équipe vous contactera sous 48h avec une proposition personnalisée.
                            </div>
                            ...
                            <form onsubmit="handleSubmit(event, 'devis')">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="devis-name" name="name" required placeholder="Votre nom ou raison sociale">
                                </div>

                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                    <div class="input-group">
                                        <label for="devis-email" class="required">Email professionnel</label>
                                        <input type="email" id="devis-email" name="email" required placeholder="email@entreprise.tg">
                                    </div>
                                    <div class="input-group">
                                        <label for="devis-phone" class="required">Téléphone</label>
                                        <input type="tel" id="devis-phone" name="phone" required placeholder="+228 XX XX XX XX">
                                    </div>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="checkbox-group">
                                        <div class="checkbox-item" onclick="toggleCheckbox(this)">
                                            <input type="checkbox" name="services" value="maintenance" id="svc-maintenance">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea id="devis-description" name="description" required placeholder="Décrivez votre projet en détail : objectifs, fonctionnalités souhaitées, public cible, etc."></textarea>
                                </div>

                                <!-- Fichiers -->
                                <div class="input-group">
                                    <label for="devis-file">Documents complémentaires (cahier des charges, inspirations...)</label>
                                    <input type="file" id="devis-file" name="file" style="padding: 12px; color: var(--text-secondary);" accept=".pdf,.doc,.docx,.jpg,.png">
                                    <small style="color: var(--text-muted); font-size: 0.8rem;">PDF, Word ou images (max 10Mo)</small>
                                </div>
                        ...
                        <div class="info-card">
                            ...
                            <div class="contact-info-item" style="background: linear-gradient(135deg, rgba(139, 92, 246, 0.1) 0%, transparent 100%); border-color: var(--primary);">
                                <div class="contact-icon">
                            ...
                            <div style="margin-top: 30px; padding: 20px; background: var(--bg-input); border-radius: 12px; border: 1px solid var(--border);">
                                <h4 style="color: var(--primary); margin-bottom: 10px; font-size: 0.9rem;">💡 Besoin d'aide ?</h4>
                                <p style="color: var(--text-secondary); font-size: 0.9rem; line-height: 1.6;">
                                    Vous n'êtes pas sûr de ce dont vous avez besoin ? <a href="#" onclick="switchForm('contact'); return false;" style="color: var(--primary);">Contactez-nous directement</a> pour un conseil personnalisé.
                                </p>
                            </div>
                        </div>
                    </div>
