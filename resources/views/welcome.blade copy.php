        ...
        <section class="hook">
            <div class="hook-inner">
                <div class="hook-content">
                    ...
                    <h3 class="hook-tag">
                        Un travail d’excellence en un temps record
                    </h3>

                    <p class="hook-description">
                        Votre partenaire de confiance en maintenance informatique,
                        photographie, reportage, montage vidéo,
                        graphisme et développement web.
                    </p>

                    <a href="..." class="cta-btn" target="_blank">
                        💬 Découvrir notre système de réduction
                    </a>
                </div>
            </div>
        </section>
                        ...
                        <div class="webContent">
                            <div class="contentImg">
                                <a href="{{ route('services.infographie') }}" target="_blank"><img
                                        src="../images/infographie.webp" alt="service infographie" class="contentImage"></a>
                            </div>
