    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <nav class="hidden md:flex items-center space-x-6">
                <a href="<?php echo e(route('courses.index')); ?>" class="nav-link text-gray-700 hover:text-brand-600 font-medium py-2">Nos formations</a>
                ...
                <div class="relative group" id="desktop-services-dropdown">
                    ...
                    <div class="absolute top-full left-0 mt-2 w-72 bg-white rounded-xl shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-left z-50 overflow-hidden">
                        ...
                        <div class="py-1">
                            <a href="<?php echo e(route('services.maintenance')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:text-brand-600 hover:bg-brand-50 transition-colors">
                            ...
                            <a href="<?php echo e(route('services.photographie')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:text-brand-600 hover:bg-brand-50 transition-colors">
                            ...
                            <a href="<?php echo e(route('services.webdev')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:text-brand-600 hover:bg-brand-50 transition-colors">
                            ...
                            <a href="<?php echo e(route('services.infographie')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:text-brand-600 hover:bg-brand-50 transition-colors">
                            ...
                            <a href="<?php echo e(route('services.assistance')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:text-brand-600 hover:bg-brand-50 transition-colors">
                ...
                <a href="<?php echo e(route('galerie')); ?>" class="nav-link text-gray-700 hover:text-brand-600 font-medium py-2">Galerie</a>
                <a href="<?php echo e(route('about')); ?>" class="nav-link text-gray-700 hover:text-brand-600 font-medium py-2">À Propos</a>
                <a href="<?php echo e(route('contact')); ?>" class="nav-link text-gray-700 hover:text-brand-600 font-medium py-2">Contact</a>
            </nav>

            <!-- CTA Desktop -->
            <div class="hidden md:block">
                <a href="<?php echo e(route('contact')); ?>" class="bg-brand-600 hover:bg-brand-700 text-white px-6 py-2.5 rounded-full font-semibold transition-all hover:scale-105 shadow-lg flex items-center gap-2">
        ...
        <nav class="flex-1 overflow-y-auto p-6 space-y-2">
            ...
            <div class="relative">
                ...
                <div id="mobile-dropdown-content" class="hidden pl-4 mt-1 space-y-1">
                    <a href="<?php echo e(route('services.maintenance')); ?>" class="flex items-center gap-3 text-gray-600 hover:text-brand-600 hover:bg-brand-50 px-3 py-2 rounded-lg text-base">
                    ...
                    <a href="<?php echo e(route('services.photographie')); ?>" class="flex items-center gap-3 text-gray-600 hover:text-brand-600 hover:bg-brand-50 px-3 py-2 rounded-lg text-base">
                    ...
                    <a href="<?php echo e(route('services.webdev')); ?>" class="flex items-center gap-3 text-gray-600 hover:text-brand-600 hover:bg-brand-50 px-3 py-2 rounded-lg text-base">
                    ...
                    <a href="<?php echo e(route('services.infographie')); ?>" class="flex items-center gap-3 text-gray-600 hover:text-brand-600 hover:bg-brand-50 px-3 py-2 rounded-lg text-base">
                    ...
                    <a href="<?php echo e(route('services.assistance')); ?>" class="flex items-center gap-3 text-gray-600 hover:text-brand-600 hover:bg-brand-50 px-3 py-2 rounded-lg text-base">
            ...
            <a href="<?php echo e(route('galerie')); ?>" class="block text-lg font-medium text-gray-700 hover:text-brand-600 hover:bg-gray-50 px-3 py-3 rounded-lg transition-colors">Galerie</a>
            <a href="<?php echo e(route('about')); ?>" class="block text-lg font-medium text-gray-700 hover:text-brand-600 hover:bg-gray-50 px-3 py-3 rounded-lg transition-colors">À Propos</a>
            <a href="<?php echo e(route('contact')); ?>" class="block text-lg font-medium text-gray-700 hover:text-brand-600 hover:bg-gray-50 px-3 py-3 rounded-lg transition-colors">Contact</a>

            <a href="<?php echo e(route('devis')); ?>" class="block mt-4 bg-brand-600 text-white text-center py-3 rounded-lg font-semibold hover:bg-brand-700 transition-colors">
                Demander un Devis
            </a>
        </nav>
    </div>
...
<?php /**PATH C:\1SSD\ProjetWeb\S228\resources\views/partials/navbar.blade.php ENDPATH**/ ?>